...
/*   Updated: 2024/02/13 15:47:51 by skwon2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	error_check(int arg, char **args)
{
	...
	i = 1;
	//j = 2; // it will get beyond the arrays of args -> gonna give segmentation fault. so when it put variables on the outside of the while loop
	// emp = "";
	// args[1] == emp ->  will only compare the addresses of it, not the contents.
	if ( arg <= 1 )
	{
		// write(1, "ERROR", 6);
		write_error();
